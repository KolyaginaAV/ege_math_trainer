    ...
    public partial class AuthorizationWindow : Window
    {
        ...
        private void ButtonAuth(object sender, RoutedEventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(BoxLogin.Text) && !string.IsNullOrWhiteSpace(BoxPassword.Text))
            {
                ...
                {
                    MessageBox.Show("Логин или пароль неверные! Зарегистрируйтесь, если у вас нет аккаунта.", "Ошибка входа");
                }
            }
            else
            {
                MessageBox.Show("Логин и пароль не введены!", "Ошибка входа");
            }
        }
