    ...
    public class AppContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            PartOneTask partOneTask5_2 = new PartOneTask() { Id = 10, Condition = "Какова вероятность того, что случайно выбранный телефонный номер оканчивается двумя чётными цифрами?",
                Decision = "Вероятность того, что на одном из требуемых мест окажется чётное число, равна 0,5. Следовательно, вероятность того, что на двух местах одновременно окажутся два чётных числа, равна 0,5 · 0,5  =  0,25.",
            ...
            PartOneTask partOneTask6_2 = new PartOneTask() { Id = 12, Condition = "Найдите корень уравнения (x-1)³=-8", Decision = "Извлекая кубический корень из обеих частей уравнения, получаем x-1=-2 откуда x=-1.",  
            ...
            PartOneTask partOneTask7_2 = new PartOneTask() { Id = 14, Condition = "Найдите значение выражения log₃1,8+log₃5.", Decision = "Найдем значение выражения: log₃1,8+log₃5=log₃(1,8*5)=log₃9=2",
            ...
            PartTwoTask partTwoTask17_2 = new PartTwoTask() { Id = 10, Condition = "  На диагонали параллелограмма взяли точку, отличную от её середины. Из неё на все стороны параллелограмма (или их продолжения) опустили перпендикуляры.\n  а) Докажите, что четырёхугольник, образованный основаниями этих перпендикуляров, является трапецией.\n  б) Найдите площадь полученной трапеции, если площадь параллелограмма равна 16, а один из его углов равен 60°.", 
                ...
                CriteriaId = criteria17.Id, TaskId = Task17.Id};
            PartTwoTask partTwoTask18 = new PartTwoTask() { Id = 11, Condition = "  Найдите все значения a, при которых уравнение (x²-x-a)²=2x⁴+2(x+a)² имеет единственное решение на отрезке [−1; 1].", 
            ...
            PartTwoTask partTwoTask18_2 = new PartTwoTask() { Id = 12, Condition = "  Найдите все значения a, при каждом из которых уравнение |x²-2xa+7|=|6a-x²-2x-1| имеет более двух корней.", 
